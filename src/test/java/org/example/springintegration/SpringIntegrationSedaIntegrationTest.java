...
import org.example.springintegration.config.ChannelConfiguration;
import org.example.springintegration.config.IntegrationConfiguration;
import org.example.springintegration.config.TaskExecutorConfiguration;
...
@EnableIntegration
@IntegrationComponentScan(basePackages = { "org.example.springintegration" })
class SpringIntegrationSedaIntegrationTest {
    @Autowired
    IncomingGateway testGateway;
