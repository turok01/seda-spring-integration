package org.example.apachecamel;
...
class ApacheCamelWordCountRouteTest extends CamelTestSupport {
    ...
    @Test
    public void givenTextWithDuplicateWords_whenSendingTextToInputUri_thenWordCountReturnedAsMap()
        throws InterruptedException {
        Map<String, Long> expected = new HashMap<>();
        expected.put("the", 3L);
        expected.put("dog", 1L);
        ...
        MockEndpoint mockEndpoint = getMockEndpoint(WordCountRoute.returnResponse);
